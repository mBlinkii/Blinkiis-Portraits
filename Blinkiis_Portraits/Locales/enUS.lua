...
L["Clickable Portraits"] = "Clickable Portraits"
L["ElvUI Options"] = "ElvUI Options"
L["Show the options inside the ElvUI options menu."] = "Show the options inside the ElvUI options menu."
L["Enable mouse interaction on the portraits. Disabling this uses non-secure click-through frames and can reduce taint."] = "Enable mouse interaction on the portraits. Disabling this uses non-secure click-through frames and can reduce taint."
...
L["Ignore Class Icons"] = "Ignore Class Icons"
L["Ignore the global class icon setting for this portrait."] = "Ignore the global class icon setting for this portrait."
L["Anchor"] = "Anchor"
...
L["Copies the settings of the selected portrait to this one. Enable state and parent frame stay untouched."] = "Copies the settings of the selected portrait to this one. Enable state and parent frame stay untouched."
L["Copy the settings from %s to %s?"] = "Copy the settings from %s to %s?"
L["Target"] = "Target"
...
L["Opens a snapshot of your settings to attach to a bug report, ready to copy or screenshot. The same window is shown by /bp report."] =
	"Opens a snapshot of your settings to attach to a bug report, ready to copy or screenshot. The same window is shown by /bp report."
L["Show Report"] = "Show Report"
L["Select the text and press Ctrl+C to copy it."] = "Select the text and press Ctrl+C to copy it."
...
L["Blizz Up"] = "Blizz Up"
L["Circle"] = "Circle"
L["Blizz Round"] = "Blizz Round"
L["Blizz Round Up"] = "Blizz Round Up"
L["Cookie"] = "Cookie"
L["Diagonal"] = "Diagonal"
...
L["Trapezoid Mirror"] = "Trapezoid Mirror"
L["Oval"] = "Oval"
...
L["Round Leaf"] = "Round Leaf"
L["Round Pulse"] = "Round Pulse"
L["Round Star"] = "Round Star"
L["Round Zickzack"] = "Round Zickzack"

L["Snake"] = "Snake"
L["Square Leaf"] = "Square Leaf"
L["Square Loop"] = "Square Loop"
...
L["Health"] = "Health"
L["Cast"] = "Cast"
L["Fills the portrait border radially with the health or the cast of the unit."] = "Fills the portrait border radially with the health or the cast of the unit."
L["Clockwise"] = "Clockwise"
L["Fills the ring clockwise, counter-clockwise when disabled."] = "Fills the ring clockwise, counter-clockwise when disabled."
L["Reverse Fill"] = "Reverse Fill"
L["The ring fills with the missing health instead of draining, so it stays empty at full health."] = "The ring fills with the missing health instead of draining, so it stays empty at full health."
L["Start Point"] = "Start Point"
L["Where the fill starts, 0 is the twelve o'clock position."] = "Where the fill starts, 0 is the twelve o'clock position."
L["Ring Alpha"] = "Ring Alpha"
L["Border Alpha"] = "Border Alpha"
L["Opacity of the portrait border below the ring."] = "Opacity of the portrait border below the ring."
L["Edge Softness"] = "Edge Softness"
L["Softens the edge of the radial fill."] = "Softens the edge of the radial fill."
L["Ring Health"] = "Ring Health"
L["Ring Cast"] = "Ring Cast"
